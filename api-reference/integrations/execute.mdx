...
## Why use this?
- Trigger real actions in connected apps (send an email, create an issue, post a message)
- One consistent endpoint across all integrations
- Works with agentic tools or direct API calls
