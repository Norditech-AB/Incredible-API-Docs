...
description: "Execute a feature from a connected integration to perform real actions (send an email, create an issue, post a message) with one consistent endpoint across integrations."
---
