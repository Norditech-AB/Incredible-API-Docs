...
Run a feature from a connected integration on behalf of a user.

## Why use this?
- Perform actions in other apps (e.g., send email, post message)
- Consistent interface across integrations
- Works well with agentic automation
