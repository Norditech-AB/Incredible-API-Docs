...
Run a specific feature from a connected integration to take action in another app (for example, send an email or post a message) via a consistent interface across integrations.
