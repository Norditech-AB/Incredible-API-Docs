...
description: "Generate AI responses with support for function calling and integrations"
---

# Chat Completion

The Chat Completion API allows you to generate AI responses using various models with support for function calling, integrations, and both streaming and non-streaming responses.
...
<ParamField body="stream" type="boolean" default="true">
  Whether to return a streaming response or a complete response.
</ParamField>
