...
description: "Connect a user’s account so your app can use that integration’s features. Supports API key and OAuth flows and is required before executing features."
