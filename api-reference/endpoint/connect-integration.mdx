...
Connect a user’s account so your app can use that integration.

## Why use this?
- Enable features that act in the user’s account
- Supports API key and OAuth flows
- Needed before executing any features
