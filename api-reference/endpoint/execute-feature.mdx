...
Run a feature from a connected integration.

## Why use this?
- Take actions in other apps (send email, create issue, post message)
- One endpoint that works across integrations
- Plays well with agentic workflows
