...
Run a feature from a connected integration to take action in another app (send email, create issue, post message) using a single endpoint that works across integrations.
